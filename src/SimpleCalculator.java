...
//        short s = 32767;
//
//        System.out.print(x + " integer number data type number is how large a data set you can use and it is also\n" +
//        " 4 bytes in size.");
//        System.out.print(y + " double data type number is larger than an int but in decimals");
